        ...
        <div className="grid">
          ...
          <form autoComplete="off" className="form login">
            ...
            <div className="form__field">
              ...
              <input onChange={e => changeUser(e)} name="password" value={user.password} id="login__password" type="password" className="form__input" placeholder="Password" required />
            </div>
            {
                  useLocation().pathname === "/register"  ?
                  <div className="form__field">
              ...
              <input onChange={e => changeUser(e)} name="re_password" value={user.re_password} autoComplete="password" id="login__username" type="password"  className="form__input" placeholder="Confrim Password" required />
            </div>
                  : <> </>
              }
            <div className="form__field">
